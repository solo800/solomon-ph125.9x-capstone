...
This project utilized generative AI tools in an assistive capacity. A local Large Language Model (LLM) was occasionally employed for code drafting and file manipulation to automate repetitive tasks that lacked significant intellectual or educational value. Additionally, an LLM provided editorial feedback on the report prose. However, all analytical decisions, model implementations, and written content remain my own. The core analysis pipeline, modeling choices, and conclusions represent original work; AI tools were used solely to accelerate drafting and identify errors rather than to generate the underlying analysis.
